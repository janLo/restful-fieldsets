...
from flask_restful_fieldsets.fieldset import DefaultMeta, FieldSetParser


def _convert_nested(mydict):
...
class TestSimpleFieldset(unittest.TestCase):
    def test_0010_empty(self):
        ...
        self.assertIsInstance(dummy.meta, DefaultMeta)
...
class TestNestedFieldset(unittest.TestCase):
    def test_0010_simple_setup(self):
        ...
        class MyFieldSet(fieldset.Fieldset):
            test01 = fields.Boolean
            test02 = fieldset.OptionalNestedField(SimpleNestedFieldset, None, None)
    ...
    def test_0020_simple_multiple_nesting(self):
        ...
        class SimpleNestedFieldset1(fieldset.Fieldset):
            nest01 = fieldset.OptionalNestedField(SimpleNestedFieldset2, None, None)
            nest02 = fields.Boolean

        class MyFieldSet(fieldset.Fieldset):
            test01 = fields.Boolean
            test02 = fieldset.OptionalNestedField(SimpleNestedFieldset1, None, None)

        dummy = MyFieldSet()
        to_check = _convert_nested(dummy.marshall_dict())
        self.assertEqual(to_check, {"test01": MyFieldSet.test01,
    ...
    def test_0030_default_embedd_nesting_setup(self):
        ...
        class MyFieldSet(fieldset.Fieldset):
            ...
            test01 = fields.Boolean
            test02 = fieldset.OptionalNestedField(SimpleNestedFieldset1, None, None)
            test03 = fieldset.OptionalNestedField(SimpleNestedFieldset2, None, None)
            test04 = fieldset.OptionalNestedField(SimpleNestedFieldset3, None, None)
    ...
    def test_0035_default_embedd_none_setup(self):
        class SimpleNestedFieldset1(fieldset.Fieldset):
            nest01 = fields.Integer
            nest02 = fields.Boolean
    ...
    def test_0060_default_embedd_nesting_multi_setup(self):
        ...
        class SimpleNestedFieldset4(fieldset.Fieldset):
            nest01 = fields.Integer
            nest02 = fieldset.OptionalNestedField(SimpleNestedFieldset1, None, None)
            nest03 = fieldset.OptionalNestedField(SimpleNestedFieldset2, None, None)
        ...
        class MyFieldSet(fieldset.Fieldset):
            ...
            test01 = fields.Boolean
            test02 = fieldset.OptionalNestedField(SimpleNestedFieldset3, None, None)
            test03 = fieldset.OptionalNestedField(SimpleNestedFieldset4, None, None)
